...
module.exports.installKindlegen = async (forceInstall = false) => {
  if (!fs.existsSync(kindlegenPath())) {
    ...
    if (process.platform === "darwin" && process.arch === "x32") {
      binUrl =
        "https://archive.org/download/kindlegen-mac-i386-v2-9/KindleGen_Mac_i386_v2_9.zip"
    } else if (process.platform === "linux") {
      binUrl =
        "https://archive.org/download/kindlegen_linux_2_6_i386_v2_9/kindlegen_linux_2.6_i386_v2_9.tar.gz"
    } else if (process.platform === "win32") {
      binUrl =
        "https://archive.org/download/kindlegen_win32_v2_9/kindlegen_win32_v2_9.zip"
    } else {
