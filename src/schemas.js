...
const schemaMetadata = Joi.object({
  ...
  title: schemaTitle,
  subtitle: Joi.string(),
  author: Joi.alternatives().try(Joi.string(), schemaStrings),
  creator: schemaCreator,
  contributor: schemaCreator,
  date: Joi.string().isoDate(),
  lang: Joi.string(),
  subject: Joi.alternatives().try(Joi.string(), schemaStrings),
